...
class BeveragesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val query = FirestoreReferences.findRecipeByClassification(searchItem!!, "Beverage")
        ...
        beveragesRV.adapter = adapter
        beveragesRV.layoutManager = LinearLayoutManager(this.context)
    }
